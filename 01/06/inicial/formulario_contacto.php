            ...
            <div class="content" data-slug="panel1">
              <form action="formulario_contacto_proceso.php" method="post">
                ...
                <div class="row collapse">
                  ...
                  <div class="large-10 columns">
                    <input type="radio" name="area" value="atencion" id="areaAtencion"><label for="areaAtencion">Atención a clientes</label>
                ...
                <div class="row collapse">
                  <div class="large-2 columns">
                    <label class="inline">Área de interés</label>
                  </div>
                  <div class="large-10 columns">
                ...
                <div class="row collapse">
                  <div class="large-2 columns">
                    <label class="inline">Número de gente en su compañía</label>
                  </div>
                  <div class="large-10 columns">
